...
#ifndef APP_PN532_PN532_H_
#define APP_PN532_PN532_H_
...
//#define PN532DEBUGPRINT //TODO DEBUG 输出
...
bool readTargetID(uint8_t cardbaudrate);
//bool readPassiveTargetID(uint8_t cardbaudrate, uint8_t * uid,uint8_t * uidLength, uint16_t timeout);
bool inListPassiveTarget() ;
void writecommand(uint8* cmd, uint8 cmdlen);
#endif /* APP_PN532_PN532_H_ */
